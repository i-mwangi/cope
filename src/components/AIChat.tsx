...
const CHAT_STORAGE_KEY = 'cope_chat_messages';
    ...
    setMessages([
      {
        id: '1',
        sender: 'ai',
        content: 'Hello! I\'m your COPE assistant. I can help you manage your portfolio, provide market insights, and suggest optimal allocations. How can I assist you today?',
        timestamp: new Date(),
      }
    ]);
  };
      ...
      <Card className="card-glass overflow-hidden">
                  ...
                  <div className={`max-w-[80%] ${msg.sender === 'user' ? 'bg-nebula-800' : 'bg-cosmic-700'} rounded-2xl p-4`}>
                    <div className="flex items-center mb-2">
                      ...
                      <span className="ml-2 font-medium">
                        {msg.sender === 'user' ? 'You' : 'COPE Assistant'}
                      </span>
                ...
                <div className="flex justify-start">
                  <div className="bg-cosmic-700 rounded-2xl p-4 max-w-[80%]">
                    <div className="flex items-center">
                      ...
                      <span className="ml-2 font-medium">COPE Assistant</span>
                    </div>
        ...
        <CardFooter className="p-4 border-t border-[#ffffff1a]">
          <div className="flex w-full space-x-2">
            <Input
              placeholder="Ask COPE assistant about market trends, tokens, or portfolio advice..."
              value={message}
