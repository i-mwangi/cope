...
import { PleasingNeuralLogo } from './PleasingNeuralLogo';
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button 
              variant="outline" 
              size="sm" 
              className="bg-gradient-to-r from-purple-800 via-fuchsia-600 to-pink-400 text-white border-none hover:opacity-90 w-full md:w-auto justify-start md:justify-center"
    ...
    <>
      <div className="flex items-center justify-between py-6 px-4 md:px-8">
        <div className="flex items-center space-x-3">
          {/* NeuralAdvisor logomark */}
          <div className="h-12 w-12 flex items-center justify-center">
            <PleasingNeuralLogo size={48} />
          </div>
          <h1 className="text-3xl font-extrabold tracking-wide uppercase bg-gradient-to-r from-[#6C3FC5] to-[#E754C5] text-transparent bg-clip-text font-sans">COPE</h1>
        </div>
