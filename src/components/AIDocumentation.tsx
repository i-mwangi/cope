    ...
    <div className="space-y-6">
      <Card className="card-glass">
        <CardHeader>
          ...
          <CardDescription>
            How COPE uses artificial intelligence to enhance your DeFi experience
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="overview" className="space-y-4">
            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="prose prose-invert max-w-none">
                ...
                <p>
                  COPE uses advanced artificial intelligence to transform how users interact with 
                  decentralized finance on Blockchain. Our AI system combines multiple technologies 
                ...
                <p>
                  This multi-layered approach ensures that COPE provides accurate, helpful, and 
            ...
            <TabsContent value="models" className="space-y-4">
              <div className="prose prose-invert max-w-none">
                ...
                <p>
                  COPE leverages state-of-the-art AI models to power its intelligent features. 
                ...
                <div className="bg-cosmic-800 p-4 rounded-lg mt-4">
                  ...
                  <p className="mt-2">
                    ...
                    understanding and generation capabilities. This model enables COPE to:
                  </p>
                  <ul className="mt-2">
            ...
            <TabsContent value="data" className="space-y-4">
              <div className="prose prose-invert max-w-none">
                ...
                <p>
                  COPE's AI system integrates multiple data sources to provide comprehensive insights 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  <div className="bg-cosmic-800 p-4 rounded-lg">
                    ...
                    <ul className="mt-2">
                      <li>Blockchain Explorer API for transaction data</li>
                    ...
                    <p className="mt-2 text-xs text-muted-foreground">
                      Data is fetched in real-time from the  blockchain for the most current insights.
                    </p>
                  </div>
                ...
                <p>
                  COPE respects user privacy and data security:
                </p>
                <ul>
...
{`You are a blockchain analyst specializing in whale transaction analysis . 
...
Keep your analysis factual and evidence-based. Mention if certain conclusions are speculative.`}
                ...
                <div className="bg-cosmic-800 p-4 rounded-lg mt-4 font-mono text-sm overflow-x-auto">
                  ...
                  <pre className="whitespace-pre-wrap">
{`You are an AI portfolio advisor specializing in crypto asset allocation for Blockchain.
...
Clearly indicate when advice is speculative vs data-driven.`}
            ...
            <TabsContent value="limitations" className="space-y-4">
              <div className="prose prose-invert max-w-none">
                ...
                <div className="bg-amber-500/10 border border-amber-500/20 p-4 rounded-lg mt-4">
                  ...
                  <p className="mt-2">
                    COPE's AI features are designed to assist with portfolio management and market analysis, 
          ...
          <CardContent>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>Real-time  blockchain data processing</span>
              </li>
              <li className="flex items-start gap-2">
                <div className="rounded-full bg-nebula-500/20 p-1 mt-0.5">
                  <Database className="h-3 w-3 text-nebula-400" />
      ...
      <Card className="card-glass">
        <CardHeader>
          ...
          <CardDescription>
            How our AI system is integrated into the COPE platform
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="prose prose-invert max-w-none">
            <p>
              COPE's AI capabilities are implemented through a sophisticated architecture that
            ...
            <ul>
              ...
              <li>Deeper integration with BLOCKCHAIN's unique features and capabilities</li>
