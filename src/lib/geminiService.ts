...
export async function generateTokenInsights(symbol: string, context?: string): Promise<string> {
  ...
  try {
    ...
    const prompt = `
      ...
      Note: This is for a portfolio management application focused on blockchain tokens.
    `;
...
export async function generateChatResponse(
  ...
  try {
    ...
    const prompt = `
      You are COPE, an AI assistant specializing in cryptocurrency portfolio management and market analysis.
